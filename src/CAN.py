...
class CAN(object):
    def __init__(self, sess):
        self.sess = sess
        self.data = glob(os.path.join("./", 'data/train', '*.jpg'))########## '*/*.jpg' 해야 모든 파일 읽어 옴 (디렉터리 안의 이미지)
        ...
        self.checkpoint_dir = 'data/new_checkpoint'
        self.checkpint_dir_model = 'data'
        ...
        self.csv_file_path = 'data/all_data_info.csv'
