...
class DCGAN(object):
    def __init__(self, sess):
        self.sess = sess
        self.data = glob(os.path.join("./", '/content/drive/MyDrive/CAN/dataimpresio/training',
                                      '*/*.jpg'))
        self.sample_dir = '/content/drive/MyDrive/CAN/dataimpresio/samples'
    ...
    def train(self):
        ...
        self.writer = tf.summary.FileWriter("/content/drive/MyDrive/CAN/dataimpresio/logs", self.sess.graph)
        ...
        drive_checkpoint_dir = '/content/drive/MyDrive/CAN/dataimpresio/new_checkpoint'
                ...
                if np.mod(counter, 100) == 1:
                    try:
                        ...
                        save_images(samples, image_manifold_size(samples.shape[0]),
                                    '/{}/train_{:02d}_{:04d}.png'.format('content/drive/MyDrive/CAN/dataimpresio/samples', epoch, index))
